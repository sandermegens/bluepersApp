...
import { WedstrijdComponent } from 'app/entities/wedstrijd/wedstrijd.component';
    ...
    describe('Wedstrijd Management Component', () => {
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(WedstrijdComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.wedstrijds[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
