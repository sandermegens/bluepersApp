...
import { CompetitieComponent } from 'app/entities/competitie/competitie.component';
...
describe('Component Tests', () => {
    describe('Competitie Management Component', () => {
        let comp: CompetitieComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(CompetitieComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.competities[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
