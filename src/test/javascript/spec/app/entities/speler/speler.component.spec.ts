...
import { SpelerComponent } from 'app/entities/speler/speler.component';
import { SpelerService } from 'app/entities/speler/speler.service';
import { Speler } from 'app/shared/model/speler.model';

describe('Component Tests', () => {
    describe('Speler Management Component', () => {
        let comp: SpelerComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(SpelerComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.spelers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
